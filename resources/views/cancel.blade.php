    ...
    <div class="container-fluid bg-light" style="height: 100vh;">
        <div class="card w-75 m-auto p-5">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-center">
                    <p>Si aún desea realizar el pago, haga <a href="https://trivicare.com/my-orders">click aquí</a></p>
                </div>

                <div class="d-flex justify-content-center mt-5">
                    <a href="https://trivicare.com/shop" class="btn btn-primary">Volver a la tienda</a>
                </div>
            </div>
        </div>
    </div>
