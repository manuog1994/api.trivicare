                ...
                <td valign="top" style="padding:0;Margin:0">
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Le damos las gracias por registrarse en nuestra web, por favor le pedimos
                                                                        que verifique su cuenta en el enlace que le adjuntamos a continuación.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                    ...
                    <tr style="text-align:center;">
                        <td>
                            ...
                            <p style="margin-bottom:2rem;">Pulse el siguiente botón para verificar su cuenta.</p>
                            <a style="background-color:#2ab5b2;padding:0.8rem 2rem;text-decoration:none;color:#ffffff;border-radius:20px;" href="{{ $mailData['url'] }}">Verificar</a>
                        </td>
                    </tr>
                    </table>
