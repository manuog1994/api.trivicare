...
<body
        ...
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <h1
                                                                        ...
                                                                        Aquí tiene su contraseña temporal</h1>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Hola, atendiendo a su solicitud, le enviamos su contraseña temporal para que pueda acceder a su cuenta.
                                                                        Le recomendamos que la cambie por una de su preferencia.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                    ...
                    role="presentation"
                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;margin:auto;">
                        <tr>
                            <td align="center"
                    ...
                    <tr style="text-align:center;">
                        <td>
                            <h3>Su contraseña temporal esta lista...</h3>
                            <p style="margin-bottom:2rem;">La contraseña que hemos generado es:</p>
                            <input style="background-color: #999999; padding: 10px 30px; text-align:center;" type="text" value="{{ $mailData['password'] }}" onclick="copyToClipboard(this)">
                            <p id="copy" style="font-style: italic;"><small>Haz click sobre la contraseña generada para copiarla al portapapeles.</small></p>
                            <p style="padding-bottom: 20px;">Una vez copiada dirígete a <strong>iniciar sesión</strong> en la página, pulsando el siguiente botón:</p>
                            <a href="https://trivicare.com/login" style="background-color: #999999; padding: 10px 30px; text-align:center; color: #fff; text-decoration: none;">Iniciar sesión</a>
                            <p style="padding-top: 30px;"><strong>Le recordamos que por su seguridad, debe cambiar su contraseña en su perfil.</strong></p>
                        </td>
                    </tr>
                    </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                        Para todo lo demás que quieras saber...</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
	...
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://viewstripo.email" 
                style="height:41px; v-text-anchor:middle; width:265px" arcsize="50%" stroke="f"  fillcolor="#666666">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Envios FAQ</center>
	</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
	...
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://viewstripo.email" 
                style="height:41px; v-text-anchor:middle; width:265px" arcsize="50%" stroke="f"  fillcolor="#666666">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Devoluciones FAQ</center>
	</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="msohide es-button-border"
	...
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://viewstripo.email" 
                style="height:41px; v-text-anchor:middle; width:265px" arcsize="50%" stroke="f"  fillcolor="#666666">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Pedidos FAQ</center>
	</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="msohide es-button-border"
	...
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="https://viewstripo.email" 
                style="height:41px; v-text-anchor:middle; width:265px" arcsize="50%" stroke="f"  fillcolor="#666666">
		<w:anchorlock></w:anchorlock>
		<center style='color:#ffffff; font-family:arial, "helvetica neue", helvetica, sans-serif; font-size:15px; font-weight:400; line-height:15px;  mso-text-raise:1px'>Mi perfil</center>
	</v:roundrect></a>
<![endif]-->
                                                                    <!--[if !mso]><!-- --><span
                                                                        class="msohide es-button-border"
                    ...
                    <table cellpadding="0" cellspacing="0" class="es-content" align="center"
                        style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%">
                        <tr>
                            <td align="center" bgcolor="#2AB5B2" style="padding:0;Margin:0;background-color:#2ab5b2">
                                <table bgcolor="#2AB5B2" class="es-content-body" align="center" cellpadding="0"
                                    cellspacing="0"
                                    style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#2ab5b2;width:600px">
                                    <tr>
                                        <td class="es-m-p10r es-m-p10l" align="left"
                                                                            ...
                                                                            <td align="center" valign="top"
                                                                                ...
                                                                                <a target="_blank"
                                                                                    ...
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#ffffff;font-size:14px"><img
                                                                                        ...
                                                                                        style="display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-right:15px;vertical-align:middle">Envio
                                                                                    gratis a partir de 50 €</a></td>
                                                                            <td align="center" valign="top"
                                                                                width="33.33%"
                                                                                ...
                                                                                id="esd-menu-id-1"><a target="_blank"
                                                                                    ...
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#ffffff;font-size:14px"><img
                                                                                        ...
                                                                                        align="absmiddle" width="25"
                                                                                        style="display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-right:15px;vertical-align:middle">Productos
                                                                                    de calidad</a></td>
                                                                            <td align="center" valign="top"
                                                                                width="33.33%"
                                                                                style="Margin:0;padding-left:5px;padding-right:5px;padding-top:10px;padding-bottom:10px;border:0;border-left:1px solid #ececeb"
                                                                                id="esd-menu-id-2"><a target="_blank"
                                                                                    ...
                                                                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:none;display:block;font-family:arial, 'helvetica neue', helvetica, sans-serif;color:#ffffff;font-size:14px"><img
                                                                                        ...
                                                                                        align="absmiddle" width="25"
                                                                                        style="display:inline-block !important;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic;padding-right:15px;vertical-align:middle">La
                                                                                    mejor elección</a></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
