...
<head>
    ...
    <title>TriviCare Natural Cosmetics | Bienvenid@ a nuestro newsletter</title>
    <!--[if (mso 16)]>
    <style type="text/css">
        ...
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            ...
            <tr>
                <td valign="top" style="padding:0;Margin:0">
                                                ...
                                                <tr>
                                                    <td align="center" valign="top"
                                                            ...
                                                            <tr>
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <h1
                                                                        ...
                                                                        Bienvenid@ a nuestro newsletter</h1>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center"
                                                        ...
                                                        <tr style="text-align:center;">
                                                            <td>
                                                                <h3>Aquí tienes tu cupón de descuento del 15%, cópialo y úsalo cuando tramites tu próxima compra.</h3>
                    ...
                    <tr style="text-align:center;">
                        <td>
                            <h3>Por su suscripción tendrá acceso a las mejores ofertas y descuentos</h3>
                            <p style="margin-bottom:2rem;">Este atento a nuestros correos y mantengase al dia sobre todos nuestros productos.</p>
                        </td>
                    </tr>
                    </table>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Si desea darse de baja en nuestro newsletter, pinche en el siguiente enlace. <a href="http://localhost:3000/unsubscribe">Darse de baja</a><br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
