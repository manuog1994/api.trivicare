...
<head>
    ...
    <title>TriviCare Natural Cosmetics | Factura de su Compra</title>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Gracias por confiar en nosotros, le adjuntamos la factura de su compra.    
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                                    ...
                                                                    <table cellpadding="0" cellspacing="0" width="100%"
                                                                        ...
                                                                        <tr>
                                                                            <td align="right"
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                                    Subtotal<br>@if($mailData['discount'] > 0)
                                                                                        Descuento %<br>
                                                                                        
                                                                                    @endif<b>Total (2&nbsp;item)</b>
                                                                                </p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                        ...
                                                                        <tr>
                                                                            <td align="right"
                                                                                ...
                                                                                <p
                                                                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#666666;font-size:14px">
                                                                                    {{ $mailData['subTotal'] }}
                                                                                    &euro;<br>@if($mailData['discount'] > 0)
                                                                                       -{{  $mailData['discount'] }} &euro;<br>
                                                                                    @endif<strong>{{ $mailData['total'] }}
                                                                                        &euro;</strong></p>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        productos de Trivicare Natural Cosmetics.<br></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
